...
```console
missemily2022@ubuntu:~$ git clone https://github.com/missemily2022/WhyMeManager
missemily2022@ubuntu:~$ cd WhyMeManager
missemily2022@ubuntu:~$ pip3 install -U -r requirements.txt
missemily2022@ubuntu:~$ cp sample_config.py config.py
```
...
<h1>
    <p align="center">
        <a href="https://heroku.com/deploy?template=https://github.com/missemily2022/WhyMeManager">
...
missemily2022@ubuntu:~$ git clone https://github.com/missemily2022/WhyMeManager
missemily2022@ubuntu:~$ cd WhyMeManager
missemily2022@ubuntu:~$ pip3 install pyrogram TgCrypto
missemily2022@ubuntu:~$ python3 str_gen.py
```
...
missemily2022@ubuntu:~$ git clone https://github.com/missemily2022/WhyMeManager
missemily2022@ubuntu:~$ cd WhyMeManager
missemily2022@ubuntu:~$ cp sample_config.env config.env
```
...
```console
missemily2022@ubuntu:~$ sudo docker build . -t wbb
missemily2022@ubuntu:~$ sudo docker run wbb
```
